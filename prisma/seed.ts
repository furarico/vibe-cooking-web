...
async function main() {
  ...
  const recipe1 = await prisma.recipe.create({
    data: {
      ...
      tags: ['カレー', 'チキン', '辛い'],
      imageUrl:
        'https://images.unsplash.com/photo-1565557623262-b51c2513a641?w=500', // 肉料理
      ingredients: {
        create: [
  ...
  const recipe2 = await prisma.recipe.create({
    data: {
      ...
      tags: ['パスタ', '辛い', 'イタリアン'],
      imageUrl:
        'https://images.unsplash.com/photo-1516100882582-96c3a05fe590?w=500', // パスタ・麺類
      ingredients: {
        create: [
  ...
  const recipe3 = await prisma.recipe.create({
    data: {
      title: 'サーモンのハーブ焼き',
      description:
        'ローズマリーとレモンが香る、シンプルでヘルシーなサーモン料理',
      ...
      tags: ['魚', 'ヘルシー', '洋風'],
      imageUrl:
        'https://images.unsplash.com/photo-1467003909585-2f8a72700288?w=500', // 魚料理
      ingredients: {
        create: [
        ...
        create: [
          {
            ...
            title: '下準備',
            description:
              'サーモンの水気を拭き取り、塩こしょうを振る。レモンは薄切りにする。',
            estimatedTime: 5,
          },
          {
            step: 2,
            title: '焼く',
            description:
              'フライパンにオリーブオイルを熱し、サーモンとローズマリー、レモンを並べて焼く。',
            estimatedTime: 10,
          },
          {
            step: 3,
  ...
  const recipe5 = await prisma.recipe.create({
    data: {
      ...
      tags: ['サラダ', 'ヘルシー', '洋風'],
      imageUrl:
        'https://images.unsplash.com/photo-1550304943-4f24f54ddde9?w=500', // サラダ
      ingredients: {
        create: [
      ...
      instructions: {
        create: [
          ...
          },
          {
            ...
            title: 'ドレッシングを作る',
            description:
              '卵黄、レモン汁、にんにく、マスタード、アンチョビペーストを混ぜ、少しずつオリーブオイルを加えながら乳化させる。塩こしょうで味を調える。',
            estimatedTime: 7,
          },
          {
            step: 3,
            title: '盛り付け',
            description:
              'レタスとドレッシングを和え、クルトンと削ったパルミジャーノ・レッジャーノを散らして完成。',
            estimatedTime: 3,
          },
        ],
      },
      ...
      instructions: {
        create: [
          ...
          },
          {
            ...
            title: '肉を焼く',
            description:
              'フライパンにサラダ油を熱し、豚肉を炒める。色が変わったら玉ねぎも加えて炒める。',
            estimatedTime: 5,
          },
          {
            step: 3,
  ...
  const recipe7 = await prisma.recipe.create({
    data: {
      ...
      tags: ['中華', '豆腐', '辛い'],
      imageUrl:
        'https://images.unsplash.com/photo-1534422298391-e4f8c172dddb?w=500', // 中華料理
      ingredients: {
        create: [
        ...
        create: [
          {
            ...
            title: '下準備',
            description:
              '豆腐は1.5cm角に切る。長ねぎ、生姜、にんにくはみじん切りにする。水溶き片栗粉を作る。',
            estimatedTime: 5,
          },
          {
            step: 2,
            title: '具材を炒める',
            description:
              'フライパンにごま油を熱し、ひき肉、生姜、にんにく、豆板醤を炒める。',
            estimatedTime: 5,
          },
          {
            step: 3,
            title: '煮込む',
            description:
              '甜麺醤、鶏ガラスープ、醤油、酒を加えて煮立たせる。豆腐を加えて優しく煮込む。',
            estimatedTime: 3,
          },
          {
            step: 4,
            title: '仕上げ',
            description:
              '水溶き片栗粉でとろみをつけ、長ねぎを加えて混ぜる。お好みで花椒を振る。',
            estimatedTime: 2,
          },
        ],
      },
        ...
        create: [
          {
            ...
            title: 'エビの下処理',
            description:
              'エビの背わたを取り、片栗粉と酒少々（分量外）で揉み込み、水で洗い流して水気を拭き取る。',
            estimatedTime: 5,
          },
          {
            step: 2,
            title: '具材を炒める',
            description:
              'フライパンにごま油を熱し、生姜、にんにく、豆板醤を炒め、香りが立ったら長ねぎを加えて炒める。',
            estimatedTime: 3,
          },
          {
            step: 3,
          ...
          },
          {
            ...
            title: 'エビを加える',
            description:
              'エビを加えて色が変わるまで炒める。水溶き片栗粉でとろみをつける。',
            estimatedTime: 4,
          },
        ],
      },
        ...
        create: [
          {
            ...
            title: '餡を作る',
            description:
              'ひき肉、キャベツ、ニラ、生姜、にんにく、醤油、酒、ごま油、塩をボウルに入れてよく混ぜる。',
            estimatedTime: 10,
          },
          {
            step: 2,
          ...
          },
          {
            ...
            title: '餃子を焼く',
            description:
              'フライパンにサラダ油を熱し、餃子を並べて焼き色がつくまで焼く。水を加えて蓋をし、蒸し焼きにする。',
            estimatedTime: 10,
          },
          {
            step: 4,
  ...
  const recipe10 = await prisma.recipe.create({
    data: {
      ...
      tags: ['洋食', '煮込み', '野菜たっぷり'],
      imageUrl:
        'https://images.unsplash.com/photo-1534939561126-855b8675edd7?w=500', // 煮込み料理
      ingredients: {
        create: [
      ...
      instructions: {
        create: [
          ...
          },
          {
            ...
            title: '餡を作る',
            description:
              'ひき肉、玉ねぎ、パン粉、牛乳、卵、塩、こしょうを混ぜ合わせる。',
            estimatedTime: 10,
          },
          {
            step: 3,
          ...
          },
          {
            ...
            title: '煮込む',
            description:
              '鍋にロールキャベツを並べ、水とコンソメを加えて弱火でじっくり煮込む。',
            estimatedTime: 40,
          },
        ],
      },
      ...
      instructions: {
        create: [
          ...
          },
          {
            ...
            title: '煮込む',
            description:
              '鍋にすべての材料と水、コンソメ、ローリエを入れ、アクを取りながら弱火で煮込む。',
            estimatedTime: 60,
          },
          {
            step: 3,
  ...
  const recipe12 = await prisma.recipe.create({
    data: {
      ...
      tags: ['朝食', 'デザート', '甘い'],
      imageUrl:
        'https://images.unsplash.com/photo-1484723091739-30a097e8f929?w=500', // 朝食・デザート
      ingredients: {
        create: [
  ...
  const recipe13 = await prisma.recipe.create({
    data: {
      title: 'オムライス',
      description:
        'とろとろ卵とケチャップライスが絶妙な、みんな大好きなオムライス。',
      categoryId: category2.id, // 肉料理カテゴリを想定
      prepTime: 15,
      cookTime: 20,
      servings: 2,
        ...
        create: [
          {
            ...
            title: 'ケチャップライスを作る',
            description:
              'フライパンにサラダ油を熱し、鶏肉、玉ねぎ、マッシュルームを炒める。ごはんを加えて炒め、ケチャップ、塩こしょうで味を調える。',
            estimatedTime: 10,
          },
          {
            step: 2,
            title: '卵を焼く',
            description:
              '別のフライパンにバターを熱し、溶き卵に牛乳と塩こしょうを加えたものを流し入れ、半熟に焼く。',
            estimatedTime: 5,
          },
          {
            step: 3,
            title: '盛り付け',
            description:
              'ケチャップライスを皿に盛り、卵を乗せる。お好みでケチャップをかける。',
            estimatedTime: 5,
          },
        ],
      },
  ...
  const recipe14 = await prisma.recipe.create({
    data: {
      title: 'ハンバーグ',
      description:
        'ジューシーな手作りハンバーグ。デミグラスソースや和風ソースで。',
      categoryId: category2.id, // 肉料理カテゴリを想定
      prepTime: 20,
      cookTime: 20,
      servings: 3,
        ...
        create: [
          {
            ...
            title: '下準備',
            description:
              '玉ねぎはみじん切りにして炒め、粗熱を取る。パン粉は牛乳に浸しておく。',
            estimatedTime: 7,
          },
          {
            step: 2,
            title: '種を作る',
            description:
              '合いびき肉、炒めた玉ねぎ、卵、浸したパン粉、ナツメグ、塩こしょうをボウルに入れ、粘りが出るまでよく混ぜる。',
            estimatedTime: 8,
          },
          {
            step: 3,
            title: '成形して焼く',
            description:
              '種を小判型に成形し、中央をくぼませる。フライパンにサラダ油を熱し、両面を焼き、蓋をして蒸し焼きにする。',
            estimatedTime: 15,
          },
        ],
      },
      ...
      instructions: {
        create: [
          ...
          },
          {
            ...
            title: '炒める',
            description:
              '鍋にサラダ油を熱し、豚肉、玉ねぎ、にんじん、じゃがいもの順に炒める。',
            estimatedTime: 10,
          },
          {
            step: 3,
            title: '煮込む',
            description:
              '水を加えて煮立たせ、アクを取りながら具材が柔らかくなるまで煮込む。',
            estimatedTime: 15,
          },
          {
            step: 4,
            title: 'ルーを加える',
            description:
              '一度火を止め、カレールーを溶かし入れる。再び弱火でとろみがつくまで煮込む。',
            estimatedTime: 5,
          },
        ],
      },
  ...
  const recipe16 = await prisma.recipe.create({
    data: {
      ...
      tags: ['和食', '鶏肉', '揚げ物'],
      imageUrl:
        'https://images.unsplash.com/photo-1491884592576-38221bd4314a?w=500', // 揚げ物
      ingredients: {
        create: [
        ...
        create: [
          {
            ...
            title: '下味をつける',
            description:
              '鶏もも肉を一口大に切り、醤油、酒、おろしにんにく、おろし生姜をもみ込み、15分ほど置く。',
            estimatedTime: 15,
          },
          {
            step: 2,
      ...
      instructions: {
        create: [
          ...
          },
          {
            ...
            title: '煮汁を作る',
            description:
              '鍋に味噌、みりん、酒、砂糖、水を混ぜ合わせる。生姜を加えて煮立たせる。',
            estimatedTime: 5,
          },
          {
            step: 3,
        ...
        create: [
          {
            ...
            title: '下準備',
            description:
              'えびは背わたを取り、なす、しいたけ、ピーマンは食べやすい大きさに切る。',
            estimatedTime: 10,
          },
          {
            step: 2,
        ...
        create: [
          {
            ...
            title: '具材を切る',
            description:
              'じゃがいも、にんじん、玉ねぎを乱切りにする。牛肉は食べやすい大きさに切る。',
            estimatedTime: 10,
          },
          {
            step: 2,
            title: '炒める',
            description:
              '鍋にサラダ油を熱し、牛肉を炒める。色が変わったら野菜も加えて炒める。',
            estimatedTime: 5,
          },
          {
            step: 3,
            title: '煮込む',
            description:
              'だし汁、醤油、みりん、砂糖、酒を加えて煮立たせ、アクを取りながら煮込む。',
            estimatedTime: 20,
          },
          {
            step: 4,
            title: '仕上げ',
            description:
              'じゃがいもが柔らかくなったら、絹さやを加えて彩りよく仕上げる。',
            estimatedTime: 5,
          },
        ],
      },
        ...
        create: [
          {
            ...
            title: '具材の下処理',
            description:
              '鶏肉は一口大に、ごぼう、れんこん、にんじんは乱切りに。こんにゃくは手でちぎる。干ししいたけは戻しておく。',
            estimatedTime: 15,
          },
          {
            step: 2,
            title: '炒める',
            description:
              '鍋にごま油を熱し、鶏肉を炒める。色が変わったら野菜とこんにゃくを加えて炒める。',
            estimatedTime: 5,
          },
          {
            step: 3,
            title: '煮込む',
            description:
              'だし汁、醤油、みりん、酒、砂糖を加えて煮立たせ、アクを取りながら煮込む。',
            estimatedTime: 25,
          },
        ],
      },
  ...
  const recipe21 = await prisma.recipe.create({
    data: {
      ...
      tags: ['和食', 'ご飯もの', 'お祝い'],
      imageUrl:
        'https://images.unsplash.com/photo-1481931098730-318b6f776db0?w=500', // ご飯もの・丼物
      ingredients: {
        create: [
      ...
      instructions: {
        create: [
          ...
          },
          {
            ...
            title: '具材の準備',
            description:
              'まぐろ、サーモンは薄切りにする。卵は錦糸卵にする。きゅうりは千切り、カニカマはほぐす。',
            estimatedTime: 10,
          },
          {
            step: 3,
            title: '盛り付け',
            description:
              '寿司飯を器に盛り、用意した具材を彩りよく乗せる。いくらと刻みのりを散らす。',
            estimatedTime: 5,
          },
        ],
      },
  ...
  const recipe22 = await prisma.recipe.create({
    data: {
      ...
      tags: ['和食', '汁物', '野菜たっぷり'],
      imageUrl:
        'https://images.unsplash.com/photo-1571091655789-405eb7a3a3a8?w=500', // 汁物・スープ
      ingredients: {
        create: [
        ...
        create: [
          {
            ...
            title: '具材を切る',
            description:
              '大根、にんじん、ごぼう、里芋は乱切りに。こんにゃくは手でちぎる。油揚げは短冊切り。豚肉は食べやすい大きさに切る。',
            estimatedTime: 10,
          },
          {
            step: 2,
            title: '炒める',
            description:
              '鍋にごま油を熱し、豚肉を炒める。色が変わったら野菜、こんにゃく、油揚げを加えて炒める。',
            estimatedTime: 5,
          },
          {
            step: 3,
            title: '煮込む',
            description:
              'だし汁を加えて煮立たせ、アクを取りながら具材が柔らかくなるまで煮込む。',
            estimatedTime: 15,
          },
          {
            step: 4,
            title: '味噌を溶く',
            description:
              '火を止めて味噌を溶き入れる。再び弱火で温め、器に盛り小ねぎを散らす。',
            estimatedTime: 5,
          },
        ],
      },
  ...
  const recipe23 = await prisma.recipe.create({
    data: {
      ...
      tags: ['中華', '野菜', '時短'],
      imageUrl:
        'https://images.unsplash.com/photo-1512003867696-6d5ce6835040?w=500', // 炒め物
      ingredients: {
        create: [
        ...
        create: [
          {
            ...
            title: '下準備',
            description:
              'キャベツ、ピーマン、にんじんが食べやすい大きさに切る。豚肉は一口大に切る。Aを混ぜ合わせておく。',
            estimatedTime: 7,
          },
          {
            step: 2,
            title: '炒める',
            description:
              'フライパンにごま油を熱し、豚肉を炒める。色が変わったら、にんじん、キャベツ、ピーマン、もやしの順に加えて炒める。',
            estimatedTime: 5,
          },
          {
            step: 3,
  ...
  const recipe24 = await prisma.recipe.create({
    data: {
      title: 'きんぴらごぼう',
      description:
        'ごぼうの風味とシャキシャキ食感が美味しい、ご飯が進む和食の副菜。',
      ...
      tags: ['和食', '副菜', '根菜'],
      imageUrl:
        'https://images.unsplash.com/photo-1544725176-7c40e5a71c5e?w=500', // 副菜
      ingredients: {
        create: [
          { name: 'ごぼう', amount: 1, unit: '本' },
          { name: 'にんじん', amount: 0.5, unit: '本' },
        ...
        create: [
          {
            ...
            title: 'ごぼうの下処理',
            description:
              'ごぼう、にんじんがささがきにし、ごぼうは水にさらしてアクを抜く。',
            estimatedTime: 10,
          },
          {
            step: 2,
          ...
          },
          {
            ...
            title: '味付け',
            description:
              '醤油、みりん、酒、砂糖を加えて汁気がなくなるまで炒め煮にする。いりごまを振って完成。',
            estimatedTime: 8,
          },
        ],
      },
      ...
      instructions: {
        create: [
          ...
          },
          {
            ...
            title: '浸す',
            description:
              'ほうれん草を食べやすい長さに切り、調味料に浸す。お好みでかつお節をかける。',
            estimatedTime: 1,
          },
        ],
      },
  ...
  const recipe26 = await prisma.recipe.create({
    data: {
      title: 'アボカドとエビのサラダ',
      description:
        'クリーミーなアボカドとぷりぷりのエビが美味しい、彩り豊かなサラダ。',
      categoryId: category4.id, // サラダカテゴリを想定
      prepTime: 10,
      cookTime: 5,
      servings: 2,
        ...
        create: [
          {
            ...
            title: '具材の準備',
            description:
              'エビは茹でておく。アボカドは角切りにし、レモン汁をかける。レタスは食べやすい大きさにちぎる。ミニトマトは半分に切る。',
            estimatedTime: 7,
          },
          {
            step: 2,
            title: '和える',
            description:
              'ボウルにエビ、アボカド、マヨネーズ、塩こしょうを加えて混ぜ合わせる。',
            estimatedTime: 3,
          },
          {
            step: 3,
      ...
      instructions: {
        create: [
          ...
          },
          {
            ...
            title: '炒める',
            description:
              '鍋にオリーブオイルを熱し、ベーコン、玉ねぎ、にんじん、じゃがいも、セロリの順に炒める。',
            estimatedTime: 5,
          },
          {
            step: 3,
            title: '煮込む',
            description:
              'トマト缶、水、コンソメ、キャベツを加えて煮立たせ、アクを取りながら野菜が柔らかくなるまで煮込む。',
            estimatedTime: 25,
          },
          {
            step: 4,
        ...
        create: [
          {
            ...
            title: 'とんかつを揚げる',
            description:
              '豚肉に塩こしょう（分量外）を振り、小麦粉、卵、パン粉の順につけ、170℃の油で揚げる。',
            estimatedTime: 10,
          },
          {
            step: 2,
            title: '煮汁で煮る',
            description:
              'フライパンにAと玉ねぎを入れて煮立たせる。揚がったとんかつを乗せて煮る。',
            estimatedTime: 5,
          },
          {
            step: 3,
      ...
      instructions: {
        create: [
          ...
          },
          {
            ...
            title: '卵でとじる',
            description:
              '鶏肉に火が通ったら、溶き卵を回し入れ、半熟になるまで火を通す。',
            estimatedTime: 3,
          },
          {
            step: 4,
  ...
  const recipe30 = await prisma.recipe.create({
    data: {
      ...
      imageUrl:
        'https://images.unsplash.com/photo-1512917774080-9991f1c4c750?w=500', // 多国籍料理
      ingredients: {
        create: [
        ...
        create: [
          {
            ...
            title: '下準備',
            description:
              'サフランは水（分量外）に浸しておく。アサリは砂抜きする。鶏肉、イカ、野菜を切る。',
            estimatedTime: 10,
          },
          {
            step: 2,
            title: '具材を炒める',
            description:
              'パエリア鍋にオリーブオイルを熱し、鶏肉、エビ、イカを炒めて一度取り出す。玉ねぎ、にんにく、パプリカを炒める。',
            estimatedTime: 10,
          },
          {
            step: 3,
            title: '米とスープを煮込む',
            description:
              '米を加えて透き通るまで炒める。白ワイン、サフラン水、水、コンソメ、塩こしょうを加えて煮立たせる。',
            estimatedTime: 10,
          },
          {
            step: 4,
            title: '仕上げ',
            description:
              '取り出した具材とアサリを米の上に並べ、蓋をして弱火で煮込む。水分がなくなったら火を止め、蒸らす。レモンとパセリを飾る。',
            estimatedTime: 15,
          },
        ],
      },
