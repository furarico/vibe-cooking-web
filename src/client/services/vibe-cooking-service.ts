...
export class VibeCookingService {
  constructor(private readonly localStorageRepository: ILocalStorageRepository) { }

  getVibeCookingRecipeIds(): string[] {
    return this.localStorageRepository.getItem<string[]>(VIBE_COOKING_RECIPES_KEY) || [];
  }
  ...
  addVibeCookingRecipeId(recipeId: string): void {
    ...
    this.localStorageRepository.setItem(VIBE_COOKING_RECIPES_KEY, vibeCookingRecipeIds);
  }
