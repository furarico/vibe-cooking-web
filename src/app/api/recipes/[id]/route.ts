...
// 同じサンプルデータ（本来はデータベースから取得）
const sampleRecipes = [
  {
    id: "recipe-001",
    title: "クリーミーチキンカレー",
    description: "スパイスの効いた本格的なチキンカレーです。ココナッツミルクでまろやかな仕上がりに。",
    prepTime: 20,
    cookTime: 40,
    servings: 4,
  ...
  },
  {
    id: "recipe-002",
    title: "和風パスタ きのこと海苔",
    description: "しめじとしいたけの旨味が効いた和風パスタ。海苔の風味がアクセントです。",
    prepTime: 10,
    cookTime: 15,
    servings: 2,
  ...
  },
  {
    id: "recipe-003",
    title: "チョコレートブラウニー",
    description: "濃厚なチョコレートの味わいが楽しめる手作りブラウニー。混ぜるだけで簡単！",
    prepTime: 15,
    cookTime: 30,
    servings: 6,
